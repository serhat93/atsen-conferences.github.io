...
$(document).ready(function () {
    ...
    // Countdown //
    $('#countdown').countdown({
        until: new Date(2014, 11 - 1, 7), // new Date(year, mth - 1, day, hr, min, sec) - date/time to count down to 
    ...
    // Google Map //
    $('#map_canvas').gmap({
        'center': new google.maps.LatLng(40.991452, 28.831845), // Change this to your desired latitude and longitude
        'zoom': 17,
    ...
    $('#map_canvas').gmap().bind('init', function () {
        $('#map_canvas').gmap('addMarker', {
            'id': 'marker-1',
            'position': '40.991452, 28.831845',
            'bounds': false,
            'icon': image
        }).click(function () {
            $('#map_canvas').gmap('openInfoWindow', {
                'content': '<h4>Istanbul Kultur Universitesi</h4><p><strong>AtakOy Yerleskesi</strong><br/>D100 Yanyol Bakirkoy 34140 Istanbul<br/>+90 212 465 7425</p>'
            }, this);
        });
    });
